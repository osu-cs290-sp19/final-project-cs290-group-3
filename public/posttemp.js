...
templates['posttemp'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"post-and-replies\">\r\n  <article class=\"post\" postId=\""
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.replies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "  </div>\r\n</div>\r\n";
